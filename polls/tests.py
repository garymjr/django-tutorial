...
class QuestionViewTests(TestCase):
    ...
    def test_index_view_with_a_past_question(self):
        ...
        index page.
        """
        create_question(question_text="Past question.", days=-30, choice_text="a choice")
        response = self.client.get(reverse('polls:index'))
    ...
    def test_index_view_with_two_past_questions(self):
        ...
        """
        create_question(question_text="Past question 1.", days=-30, choice_text="a choice")
        create_question(question_text="Past question 2.", days=-5, choice_text="a choice")
        response = self.client.get(reverse('polls:index'))
        self.assertQuerysetEqual(
            response.context['latest_question_list'],
    ...
    def test_index_view_with_question_with_no_choices(self):
        """
        The questions index page should not display questions with no choices.
        """
